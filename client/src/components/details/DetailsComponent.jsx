            ...
            <div className="details">
                {detail.id.length > 30?
                    <div>
                        ...
                        <br />
                        <img className="imageDet" src={detail.image? detail.image 
                ...
                <h4>ID: {detail.id}</h4>
                <br />
                <h4 className="score">Health Score: {detail.healthScore}</h4>
                <br />
                <div className="summaryDet">
                    <p>Summary: {detail.summary? detail.summary : "Nothing here"} </p>
                </div>
                <br />
                ...
                <div className="dietsDet">
                    <ul>Diets: 
                        {detail.diets && detail.diets.map((r, i)=> {
                            return( 
                                <p key={i}>{r.name}</p>
                            )
                        }) 
